#!/usr/bin/env python3
"""Generate structured GeoGuard workflow specs with Ollama."""
...
OUT_ROOT = ROOT / "experiments/04_geo_faithfulness_evaluator/outputs/workflow_spec_benchmark/generated_specs"
