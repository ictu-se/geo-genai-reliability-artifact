\begin{table}[htbp]
\centering
\caption{Lowest-scoring GeoGuard cases after excluding malformed JSON responses. This table focuses on geospatial planning weaknesses rather than format-compliance failures; the complete 360-row GeoGuard ledger remains in the repository CSV files.}
