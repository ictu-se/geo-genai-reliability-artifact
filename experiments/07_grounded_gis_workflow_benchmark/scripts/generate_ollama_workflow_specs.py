...
from common import ROOT, SPEC_ROOT, TASKS_PATH, model_slug
...
def main() -> None:
    ...
    for mode in args.modes:
        out_dir = SPEC_ROOT / model_slug(args.model) / mode
    ...
    manifest_path = SPEC_ROOT / model_slug(args.model) / "workflow_generation_manifest.json"
