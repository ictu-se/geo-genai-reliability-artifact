...
- repair model: `qwen2.5-coder:14b`
- cases: 40
- completed after iterative repair: 9
...
| deepseek-coder_6.7b | rules | C004_missing_crs_repair | 3 | 0.571 | 4/7 | False | execution_success, static_png, diagnostic_json |
...
| qwen2.5-coder_7b | basic | C003_static_full_layout | 2 | 1.000 | 6/6 | True |  |
| qwen2.5-coder_7b | basic | C004_missing_crs_repair | 3 | 0.571 | 4/7 | False | execution_success, static_png, diagnostic_json |
...
| qwen2.5-coder_7b | rules | C004_missing_crs_repair | 3 | 0.714 | 5/7 | False | execution_success, static_png |
