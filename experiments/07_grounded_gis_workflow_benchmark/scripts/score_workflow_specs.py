...
from common import ROOT, SCORE_ROOT, SPEC_ROOT, TASKS_PATH, model_slug
...
def main() -> None:
    ...
    for mode in args.modes:
        mode_dir = SPEC_ROOT / model_slug(args.model) / mode
    ...
    out_dir = SCORE_ROOT / model_slug(args.model)
